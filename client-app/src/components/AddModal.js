...
function AddModal({open, onClose}) {
    ...
    return (
        <div className="">
            <div onClick={areaClose}  className='addModal fixed z-[9999] w-screen h-screen inset-0 bg-black bg-opacity-25 backdrop-blur-sm flex justify-center items-center'>
